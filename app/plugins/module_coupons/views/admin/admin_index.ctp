...
foreach ($coupons AS $coupon)
{
	echo $admin->TableCells(
		  array(
			...
			$admin->ActionButton('edit','/module_coupons/admin/admin_edit/' . $coupon['ModuleCoupon']['id']) . $admin->ActionButton('delete','/module_coupons/admin/admin_delete/' . $coupon['ModuleCoupon']['id'])
		   ));
}
echo '</table>';
