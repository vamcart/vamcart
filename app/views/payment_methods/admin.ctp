...
foreach ($payment_method_data AS $payment_method)
{
	echo $admin->TableCells(
		  array(
				...
				$ajax->link(($payment_method['PaymentMethod']['active'] == 1?$html->image('admin/icons/true.png'):$html->image('admin/icons/false.png')), 'null', $options = array('url' => '/payment_methods/admin_change_active_status/' . $payment_method['PaymentMethod']['id'], 'update' => 'inner-content'), null, false),				
