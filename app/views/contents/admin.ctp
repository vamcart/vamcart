...
echo $admin->ActionBar(array('activate'=>__('Activate',true),'deactivate'=>__('Deactivate',true),'show_in_menu'=>__('Show In Menu',true),'hide_from_menu'=>__('Hide From Menu',true),'delete'=>__('Delete',true)),true,$last_content_id.'/'.(isset($parent_content) ? $parent_content['Content']['id'] : 0));
echo $form->end();
