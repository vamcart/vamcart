...
foreach ($global_content_blocks AS $global_content_block)
{
	echo $admin->TableCells(
		  array(
			...
			$ajax->link(($global_content_block['GlobalContentBlock']['active'] == 1?$html->image('admin/icons/true.png'):$html->image('admin/icons/false.png')), 'null', $options = array('url' => '/global_content_blocks/admin_change_active_status/' . $global_content_block['GlobalContentBlock']['id'], 'update' => 'inner-content'), null, false),
