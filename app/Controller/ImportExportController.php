                        ...
                        foreach ($content as $imp_attr) {
                            ...
                            if(isset($content['Content']['id'])) {
                                $attribute = $this->Content->Attribute->AttributeDescription->find('first'
                                        //,array('conditions' => array('AttributeDescription.name' => $data['Content']['Attribute']['name'],'Attribute.content_id' => $content['Content']['parent_id'],'AttributeDescription.language_id' => $this->data['ImportExport']['language_id'])));                         
                                        ,array('conditions' => array('AttributeDescription.name' => $data['Content']['Attribute']['name'],'AttributeDescription.language_id' => $this->data['ImportExport']['language_id'])));                         
                                if(isset($attribute['AttributeDescription']['attribute_id'])) {                                    
                                    $val_attribute = $this->Content->Attribute->AttributeDescription->find('first'
                                        //,array('conditions' => array('AttributeDescription.name' => $data['Content']['Attribute']['value'],'Attribute.parent_id' => $attribute['Attribute_p']['id'],'AttributeDescription.language_id' => $this->data['ImportExport']['language_id'])));                                                                  
                                        ,array('conditions' => array('AttributeDescription.name' => $data['Content']['Attribute']['value'],'AttributeDescription.language_id' => $this->data['ImportExport']['language_id'])));                                                                  
