...
class KvitanciaController extends PaymentAppController {
	...
	{
		$content = '
		<a class="btn btn-default" href="' . FULL_BASE_URL . BASE . '/payment/kvitancia/print_order/' . $_SESSION['Customer']['order_id'] . '" target="_blank"><i class="fa fa-print"></i> {lang}Print Order{/lang}</a><br /><br />
