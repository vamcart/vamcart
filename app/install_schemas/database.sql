...
(741,35,1,'Home','<a href=\"{base_path}/admin/\">Click here to go to the admin area.</a><br />Login: admin<br />Password: password<br />{content_listing template="subcategory-listing" parent="0" type="category" limit="3"}<br />{content_listing template="slider" parent="tablets" type="product" limit="9"}<br />{content_listing template="featured-products" parent="smartphones" type="product" limit="9"}','','','',''),
(742,35,2,'Главная страница','<a href=\"{base_path}/admin/\">Вход в админку.</a><br />Логин: admin<br />Пароль: password<br />{content_listing template="subcategory-listing" parent="0" type="category" limit="3"}<br />{content_listing template="slider" parent="tablets" type="product" limit="9"}<br />{content_listing template="featured-products" parent="smartphones" type="product" limit="9"}','','','',''),
