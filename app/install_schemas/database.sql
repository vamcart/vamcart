...
(741,35,1,'Home','<a href="{base_path}/admin/">Click here to go to the admin area.</a><br />Login: admin<br />Password: password<br />','','','',''),
(742,35,2,'Главная страница','<a href=\"{base_path}/admin/\">Вход в админку.</a><br />Логин: admin<br />Пароль: password<br />','','','',''),
