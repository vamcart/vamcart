...
(269,49,1,'Cart Contents','{shopping_cart}\r\n\r\n{content_listing template="featured-products" type="product" is_featured="1" limit="9" order="id-desc"}','','Cart Contents','Cart Contents','Cart Contents'),
(270,49,2,'Корзина','{shopping_cart}\r\n\r\n{content_listing template="featured-products" type="product" is_featured="1" limit="9" order="id-desc"}','','Корзина','Корзина','Корзина'),
(313,53,1,'Thank You','Thanks for shopping!\r\n\r\n{content_listing template="featured-products" type="product" is_featured="1" limit="9" order="id-desc"}\r\n\r\n{my_orders}','','Thank You','Thank You','Thank You'),
...
(823, 110, 1, '404', 'Page not found.<br /><br />We couldn\'t find that page.<br /><br />Try searching.<br /><br />{content_listing template="featured-products" type="product" is_featured="1" limit="9" order="id-desc"}', '', '404', '404', '404'),
(824, 110, 2, '404', 'Страница не найдена.<br /><br />Неправильно набран адрес, либо такой страницы больше не существует.<br /><br />Вы можете воспользоваться поиском.<br /><br />{content_listing template="featured-products" type="product" is_featured="1" limit="9" order="id-desc"}', '', '404', '404', '404');
...
(9, 'opengraph-image', '{$images.0.image}', '2019-01-30 20:10:17', '2019-01-30 20:15:47', 'content_images');
