...
(8, 'search-result-ajax', '{if $content_list}\r\n<table class="table table-striped table-hover hidden-xs">\r\n  <thead>\r\n	<tr>\r\n		<th colspan="3">{lang}Top 10 results...{/lang}</th>\r\n	</tr>\r\n	</thead>\r\n\r\n  <tbody>\r\n{foreach from=$content_list item=product}\r\n	<tr>\r\n		<td class="text-center"><img class="media-object" src="{$product.image}" alt="{$product.name}"{if {$product.image_width} > 0} width="{$product.image_width}"{/if}{if {$product.image_height} > 0} height="{$product.image_height}"{/if} /></td>\r\n		<td><a href="{$product.url}">{$product.name}</a></td>\r\n		<td>{$product.price}</td>\r\n	</tr>\r\n{/foreach}\r\n  </tbody>\r\n</table>\r\n{/if}  \r\n', '2018-10-26 21:51:26', '2018-10-26 22:21:01', 'search_result');
