...
INSERT INTO `micro_templates` VALUES (3, 'information-links', '<li{if $content_alias == \'home-page\'} class="current"{/if}><a href="{base_path}/">&nbsp;<img src="{base_path}/img/icons/page/home.png" width="15" height="14" border="0" alt="" /><span>{lang}Home{/lang}</span></a></li>\r\n{foreach from=$content_list item=node}\r\n<li{if $node.alias == $content_alias} class="current"{/if}><a href="{$node.url}">{if $node.icon}&nbsp;<img src="{$node.icon}" width="14" height="14" />{/if}<span>{$node.name}</span></a></li>\r\n{/foreach}\r\n', '2009-07-30 15:42:21', '2009-07-12 15:41:54', 'content_listing');
...
INSERT INTO `micro_templates` VALUES (12, 'product-listing', '<div>\r\n {if $pages_number > 1 || $page==''all''}\r\n    <div class="paginator">\r\n          <ul>\r\n            <li>{lang}Pages{/lang}:</li>\r\n            {for $pg=1 to $pages_number}\r\n            <li><a href="/category/{$content_alias->value}{$ext}/page/{$pg}" {if $pg == $page}class="current"{/if}>{$pg}</a></li>\r\n            {/for}\r\n            <li><a href="/category/{$content_alias->value}{$ext}/page/all" {if ''all'' == $page}class="current"{/if}>{lang}All{/lang}</a></li>\r\n          </ul>\r\n    </div>\r\n  {/if}  \r\n<ul class="listing">\r\n{foreach from=$content_list item=node}\r\n	<li\r\n	{if $node.alias == $content_alias}\r\n		class="active"\r\n	{/if}\r\n	>\r\n	<div><a href="{$node.url}"><img src="{$node.image}" alt="{$node.name}" \r\n	{if isset($thumbnail_width)}\r\n	 width="{$thumbnail_width}"\r\n	{/if}\r\n	/></a></div>\r\n	<div><a href="{$node.url}">{$node.name}</a></div></li>\r\n{foreachelse}\r\n	<li class="no_items">{lang}No Items Found{/lang}</li>\r\n{/foreach}\r\n</ul>\r\n<div class="clear"></div> \r\n\r\n  {if $pages_number > 1 || $page==''all''}\r\n    <div class="paginator">\r\n          <ul>\r\n            <li>{lang}Pages{/lang}:</li>\r\n            {for $pg=1 to $pages_number}\r\n            <li><a href="/category/{$content_alias->value}{$ext}/page/{$pg}" {if $pg == $page}class="current"{/if}>{$pg}</a></li>\r\n            {/for}\r\n            <li><a href="/category/{$content_alias->value}{$ext}/page/all" {if ''all'' == $page}class="current"{/if}>{lang}All{/lang}</a></li>\r\n          </ul>\r\n    </div>\r\n  {/if}  \r\n  \r\n</div>\r\n', '2009-07-12 18:52:23', '2009-07-12 18:57:08', 'content_listing');
