...
(44, 0, 4, 0, 1, 1, 0, 'information', '', 1, 0, 0, '2009-07-30 15:34:48', '2009-07-30 15:35:02'),
(45, 44, 1, 0, 3, 1, 0, 'shipping--returns', '', 1, 1, 0, '2009-07-30 15:36:30', '2009-08-06 14:53:16'),
(46, 44, 1, 0, 3, 1, 0, 'privacy-policy', '', 1, 1, 0, '2009-07-30 15:36:54', '2009-07-30 15:37:09'),
(47, 44, 2, 0, 3, 1, 0, 'conditions-of-use', '', 1, 1, 0, '2009-07-30 15:37:33', '2009-07-30 15:37:33'),
(48, 44, 3, 0, 3, 1, 0, 'contact-us', '', 1, 1, 0, '2009-07-30 15:38:03', '2009-07-30 15:38:03'),
(49, -1, 5, 0, 3, 1, 0, 'cart-contents', '', 1, 1, 0, '2009-07-30 20:40:14', '2009-08-09 16:23:47'),
(50, -1, 6, 0, 3, 1, 0, 'checkout', '', 1, 1, 0, '2009-07-30 20:52:36', '2009-08-01 16:54:56'),
(51, -1, 5, 0, 3, 1, 0, 'confirmation', '', 1, 1, 0, '2009-08-07 11:16:28', '2009-09-01 16:22:10'),
(53, -1, 5, 0, 3, 1, 0, 'success', '', 1, 1, 0, '2009-08-07 11:58:21', '2009-08-15 16:00:40'),
(58, -1, 0, 0, 3, 1, 0, 'read-reviews', '', 1, 0, 0, '2009-08-20 09:37:04', '2009-08-20 09:37:04'),
(59, -1, 0, 0, 3, 1, 0, 'create-review', '', 1, 0, 0, '2009-08-20 09:37:04', '2009-08-20 09:37:04'),
(68, -1, 0, 0, 3, 1, 0, 'coupon-details', '', 1, 0, 0, '2009-09-13 11:11:08', '2009-09-13 11:11:08'),
(69, 0, 5, 0, 1, 1, 0, 'news', '', 1, 0, 0, '2009-11-10 20:18:22', '2009-11-10 20:18:22'),
(70, 0, 6, 0, 1, 1, 0, 'articles', '', 1, 0, 0, '2009-11-10 20:18:45', '2009-11-10 20:18:45'),
(71, 69, 1, 0, 5, 1, 0, 'sample-news', '', 1, 1, 0, '2009-11-10 20:20:08', '2009-11-10 20:20:08'),
(72, 70, 1, 0, 6, 1, 0, 'sample-article', '', 1, 1, 0, '2009-11-10 20:20:51', '2009-11-10 20:20:51');
...
INSERT INTO `micro_templates` VALUES (1, 'vertical-menu', '<!-- Categories box -->\r\n<div class="box">\r\n<h5><img src="{base_path}/img/admin/icons/menu/categories.png" alt="" />&nbsp;{lang}Categories{/lang}</h5>\r\n<div class="boxContent">\r\n<ul id="CatNavi">\r\n{foreach from=$content_list item=node}\r\n<li{if $node.alias == $content_alias} class="active"{/if}><a href="{$node.url}">{$node.name}</a></li>\r\n{/foreach}\r\n</ul>\r\n</div>\r\n</div>\r\n<!-- /Categories box -->', '2009-07-28 17:08:06', '2010-02-05 19:15:05', 'content_listing');
INSERT INTO `micro_templates` VALUES (3, 'information-links', '<li{if $content_alias == \'home-page\'} class="current"{/if}><a href="{base_path}/">&nbsp;<img src="{base_path}/img/admin/icons/page/home.png" width="15" height="14" border="0" alt="" /><span>{lang}Home{/lang}</span></a></li>\r\n{foreach from=$content_list item=node}\r\n<li{if $node.alias == $content_alias} class="current"{/if}><a href="{$node.url}">{if $node.icon}&nbsp;<img src="{$node.icon}" width="14" height="14" />{/if}<span>{$node.name}</span></a></li>\r\n{/foreach}\r\n', '2009-07-30 15:42:21', '2009-07-12 15:41:54', 'content_listing');
