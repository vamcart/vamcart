...
(391, 35, 1, 'Home', '<a href=\"{base_path}/admin/\">Click here to go to the admin area.</a> <br /> {content_listing template=\'slider\' parent=\'36\' type=\'product\' limit=\'5\'} <br /> {content_listing template=\'subcategory-listing\' parent=\'0\' type=\'category\' limit=\'3\'} <br />{content_listing template=\'featured-products\' parent=\'36\' type=\'product\' limit=\'3\'}','', '', ''),
(392, 35, 2, 'Главная страница', '<a href=\"{base_path}/admin/\">Вход в админку.</a> <br /> {content_listing template=\'slider\' parent=\'36\' type=\'product\' limit=\'5\'} <br /> {content_listing template=\'subcategory-listing\' parent=\'0\' type=\'category\' limit=\'3\'} <br />{content_listing template=\'featured-products\' parent=\'36\' type=\'product\' limit=\'3\'}','', '', ''),
