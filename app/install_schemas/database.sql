...
(313,53,1,'Thank You','Thanks for shopping!\r\n\r\n{content_listing template="featured-products" label_id="3" type="product" limit="9" order="ordered-desc"}\r\n','','','',''),
...
(741,35,1,'Home','<a href="{base_path}/users/admin_login/">Click here to go to the admin area.</a><br />Login: admin<br />Password: password<br /><br />','','','',''),
(742,35,2,'Главная страница','<a href="{base_path}/users/admin_login/">Вход в админку.</a><br />Логин: admin<br />Пароль: password<br /><br />','','','',''),
