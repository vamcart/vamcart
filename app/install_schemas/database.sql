...
(5,'news-box','<section class=\"widget inner categories-widget\">\r\n	<h3 class=\"widget-title\">{lang}News{/lang}</h3>\r\n		<ul class=\"icons clearfix\">\r\n			{foreach from=$content_list item=node}\r\n				<li{if $node.alias == $content_alias} class=\"active\"{/if}>{if $node.alias != $content_alias}<a href=\"{$node.url}\">{/if}{$node.name}{if $node.alias != $content_alias}</a>{/if}</li>\r\n			{/foreach}\r\n		</ul>\r\n</section>','2013-10-01 17:08:06','2013-10-07 16:20:42','content_listing'),
(6,'articles-box','<section class=\"widget inner categories-widget\">\r\n	<h3 class=\"widget-title\">{lang}News{/lang}</h3>\r\n		<ul class=\"icons clearfix\">\r\n			{foreach from=$content_list item=node}\r\n				<li{if $node.alias == $content_alias} class=\"active\"{/if}>{if $node.alias != $content_alias}<a href=\"{$node.url}\">{/if}{$node.name}{if $node.alias != $content_alias}</a>{/if}</li>\r\n			{/foreach}\r\n		</ul>\r\n</section>','2013-10-01 17:08:06','2013-10-07 16:20:44','content_listing'),
