...
(123, 1, 'Print Order', 'Country', '2009-09-12 20:08:49', '2009-09-12 20:08:49'),
(124, 2, 'Распечатать квитанцию', 'Страна', '2009-09-12 20:08:49', '2009-09-12 20:08:49');
...
(3, 'information-links', '<ul>\r\n<li{if $content_alias == \'home-page\'} class="current"{/if}><a href="{base_path}/"><span>{lang}Home{/lang}</span></a></li>\r\n{foreach from=$content_list item=node}\r\n<li{if $node.alias == $content_alias} class="current"{/if}><a href="{$node.url}"><span>{$node.name}</span></a></li>\r\n{/foreach}\r\n</ul>', '2009-07-30 15:42:21', '2009-07-12 15:41:54', 'content_listing'),
