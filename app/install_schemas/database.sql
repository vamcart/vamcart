...
(1, 1, 1, 'Your order #{$order_number}', 'Dear {$firstname}!<br /><br />Your order confirmed!<br />Order number: {$order_number}<br /><br />Products:<br />{foreach name=aussen item=products from=$products_array}<br />{$products.quantity} x {$products.name} = {$smarty.session.Customer.currency_symbol_left}{math equation="price*quantity" price={$products.price} quantity={$products.quantity}} {$smarty.session.Customer.currency_symbol_right}<br />{if $products.filename != ""}<br />{lang}Download link:{/lang} {$smarty.const.FULL_BASE_URL}{$smarty.const.BASE}/download/{$order_number}/{$products.id}/{$products.download_key}<br />{/if}<br />{/foreach}<br /><br />{lang}{$shipping_method}{/lang}:  {$shipping_total}<br />{lang}Order Total:{/lang} {$order_total}<br /><br />Shipping Method: {$shipping_method}<br />{$shipping_method_description}<br /><br />Payment Method: {$payment_method}<br />{$payment_method_description}<br /><br />Customer: {$bill_name}<br />Phone: {$phone}<br />Email: {$email}<br /><br />Shipping Address:<br />{$bill_zip}, {$bill_state}, {$bill_city}<br />{$bill_line_1} {$bill_line_2}<br /><br />{$comments}<br /><br />Thank you!<br /><br />'),
(2, 1, 2, 'Ваш заказ №{$order_number}', 'Здравствуйте, {$firstname}!<br /><br />Ваш заказ подтверждён.<br />Номер заказа: {$order_number}<br /><br />Заказанные товары:<br />{foreach name=aussen item=products from=$products_array}<br />{$products.quantity} x {$products.name} = {$smarty.session.Customer.currency_symbol_left}{math equation="price*quantity" price={$products.price} quantity={$products.quantity}} {$smarty.session.Customer.currency_symbol_right}<br />{if $products.filename != ""}<br />{lang}Download link:{/lang} {$smarty.const.FULL_BASE_URL}{$smarty.const.BASE}/download/{$order_number}/{$products.id}/{$products.download_key}<br />{/if}<br />{/foreach}<br /><br />{lang}{$shipping_method}{/lang}:  {$shipping_total}<br />{lang}Order Total:{/lang} {$order_total}<br /><br />Способ доставки: {$shipping_method}<br />{$shipping_method_description}<br /><br />Способ оплаты: {$payment_method}<br />{$payment_method_description}<br /><br />Покупатель: {$bill_name}<br />Телефон: {$phone}<br />Email: {$email}<br /><br />Адрес доставки:<br />{$bill_zip}, {$bill_state}, {$bill_city}<br />{$bill_line_1} {$bill_line_2}<br /><br />{$comments}<br /><br />Спасибо!'),
(3, 2, 1, 'Order #{$order_number}: Status Changed', 'Dear {$firstname}!<br /><br />Thank you!<br /><br />New Order Status: {$order_status}<br /><br />{$comments}<br /><br />Order number: {$order_number}<br /><br />Products:<br />{foreach name=aussen item=products from=$products_array}<br />{$products.quantity} x {$products.name} = {$smarty.session.Customer.currency_symbol_left}{math equation="price*quantity" price={$products.price} quantity={$products.quantity}} {$smarty.session.Customer.currency_symbol_right}<br />{if $products.filename != ""}<br />{lang}Download link:{/lang} {$smarty.const.FULL_BASE_URL}{$smarty.const.BASE}/download/{$order_number}/{$products.id}/{$products.download_key}<br />{/if}<br />{/foreach}<br /><br />{lang}{$shipping_method}{/lang}:  {$shipping_total}<br />{lang}Order Total:{/lang} {$order_total}<br /><br />Shipping Method: {$shipping_method}<br />{$shipping_method_description}<br /><br />Payment Method: {$payment_method}<br />{$payment_method_description}<br /><br />Customer: {$bill_name}<br />Phone: {$phone}<br />Email: {$email}<br /><br />Shipping Address:<br />{$bill_zip}, {$bill_state}, {$bill_city}<br />{$bill_line_1} {$bill_line_2}'),
(4, 2, 2, 'Изменён статус Вашего заказа №{$order_number}', 'Здравствуйте, {$firstname}!<br /><br />Спасибо за Ваш заказ!<br /><br />Статус Вашего заказа изменён.<br /><br />Новый статус заказа: {$order_status}<br /><br />{$comments}<br /><br />Номер заказа: {$order_number}<br /><br />Заказанные товары:<br />{foreach name=aussen item=products from=$products_array}<br />{$products.quantity} x {$products.name} = {$smarty.session.Customer.currency_symbol_left}{math equation="price*quantity" price={$products.price} quantity={$products.quantity}} {$smarty.session.Customer.currency_symbol_right}<br />{if $products.filename != ""}<br />{lang}Download link:{/lang} {$smarty.const.FULL_BASE_URL}{$smarty.const.BASE}/download/{$order_number}/{$products.id}/{$products.download_key}<br />{/if}<br />{/foreach}<br /><br />{lang}{$shipping_method}{/lang}:  {$shipping_total}<br />{lang}Order Total:{/lang} {$order_total}<br /><br />Способ доставки: {$shipping_method}<br />{$shipping_method_description}<br /><br />Способ оплаты: {$payment_method}<br />{$payment_method_description}<br /><br />Покупатель: {$bill_name}<br />Телефон: {$phone}<br />Email: {$email}<br /><br />Адрес доставки:<br />{$bill_zip}, {$bill_state}, {$bill_city}<br />{$bill_line_1} {$bill_line_2}'),
