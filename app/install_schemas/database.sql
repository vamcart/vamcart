...
(1, 1, 1, 'Your order #{$order_number}', 'Dear {$firstname}!\r\n\r\nYour order confirmed!\r\nOrder number: {$order_number}\r\n\r\nProducts:\r\n{foreach name=aussen item=products from=$products_array}\r\n{$products.quantity} x {$products.name} = {$smarty.session.Customer.currency_symbol_left}{math equation="price*quantity" price={$products.price} quantity={$products.quantity}} {$smarty.session.Customer.currency_symbol_right}\r\n{if $products.filename != ""}\r\n{lang}Download link:{/lang} {$smarty.const.FULL_BASE_URL}{$smarty.const.BASE}/download/{$order_number}/{$products.id}/{$products.download_key}\r\n{/if}\r\n{/foreach}\r\n\r\n{lang}{$shipping_method}{/lang}:  {$shipping_total}\r\n{lang}Order Total:{/lang} {$order_total}\r\n\r\nShipping Method: {$shipping_method}\r\n{$shipping_method_description}\r\n\r\nPayment Method: {$payment_method}\r\n{$payment_method_description}\r\n\r\nCustomer: {$bill_name}\r\nPhone: {$phone}\r\nEmail: {$email}\r\n\r\nShipping Address:\r\n{$bill_zip}, {$bill_state}, {$bill_city}\r\n{$bill_line_1} {$bill_line_2}\r\n\r\n{$comments}\r\n\r\nThank you!\r\n\r\n'),
