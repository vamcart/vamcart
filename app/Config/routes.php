 ...
 */
	...
	Router::connect('/category/filtered/:filtered/:hash/:content_alias', array('controller' => 'pages', 'action' => 'index'));
	...
	Router::connect('/yandex_turbo', array('controller' => 'sitemaps', 'action' => 'yandex_turbo', 'ext' => 'xml'));
