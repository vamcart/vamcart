...
<table class="table sortable_list">
    ...
    <tbody>        
        <tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentProduct.model','readonly' => true,'order' => 1)) . '</td><td class="priority">1</td><td>model</td><td>Артикул. <span class="text-danger">С помощью артикула производится идентификация товаров магазина, т.е. артикул - это ключ. Если товар с указанным артикулом есть уже в магазине, информация по данному товару обновляется при импорте csv файла. Если в магазине не найден товар с указанным артикулом, добавляется новый товар.</span></td></tr>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.name','readonly' => true,'order' => 2)) . '</td><td class="priority">2</td><td>name</td><td>Название товара.</td></tr>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.parents','readonly' => true,'order' => 3)) . '</td><td class="priority">3</td><td>parent</td><td>Категория товара. <span class="text-danger">К какой категории относится товара. Указывается название категории, подкатегории. Например добаляет новый телефон в категорию Смартфоны, пишем: Смартфоны. Добавляем товар в подкатегорию Аксессуары категории Смартфоны, пишем: Cмартфоны/Аксессуары.</span></td></tr>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.alias','readonly' => true,'order' => 4)) . '</td><td class="priority">4</td><td>alias</td><td>Псевдоним товара. <span class="text-danger">Проще говоря, псевдоним - это url адрес для товара, именно на основе псевдонима строится url адрес товара в магазине. Например, если укажите: tovar, то url адрес данного товара в магазине будет: http://магазин.ру/product/tovar.html.</span></td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentProduct.sku','order' => 5)) . '</td><td class="priority">5</td><td>sku</td><td>SKU - идентификатор товарной позиции, учетная единица, складской номер.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentProduct.stock','order' => 6)) . '</td><td class="priority">6</td><td>stock</td><td>Количество товара на складе.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentProduct.price','order' => 7)) . '</td><td class="priority">7</td><td>price</td><td>Цена. <span class="text-danger">Разделитель целых чисел - точка. Например, цена товара 1000 рублей 50 копеек, пишем как 1000.50</span></td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentProduct.weight','order' => 8)) . '</td><td class="priority">8</td><td>weight</td><td>Вес товара в граммах. <span class="text-danger">Например, вес товара товара 110 грамм, пишем как 0.110</span></td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentProduct.label','order' => 9)) . '</td><td class="priority">9</td><td>label</td><td>Ярлык товара, например: Новинка, Хит, Распродажа и т.д.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentProduct.manufacturer','order' => 10)) . '</td><td class="priority">10</td><td>manufacturer</td><td>Производитель. Указываем название производителя товара (брэнд).</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.description','order' => 11)) . '</td><td class="priority">11</td><td>description</td><td>Описание товара.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.short_description','order' => 12)) . '</td><td class="priority">12</td><td>short_description</td><td>Краткое описание товара.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.meta_title','order' => 13)) . '</td><td class="priority">13</td><td>meta_title</td><td>Заголовок Meta Title.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.meta_description','order' => 14)) . '</td><td class="priority">14</td><td>meta_description</td><td>Значение для тэга Meta Description.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.meta_keywords','order' => 15)) . '</td><td class="priority">15</td><td>meta_keywords</td><td>Значение для тэга Meta Keywords.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.image','order' => 16)) . '</td><td class="priority">16</td><td>image</td><td>Картинка товара. Название файла картинки товара, если картинок несколько, указывайте через точку с запятой, например: image.png;image1.png. Кроме того, можно указывать URL адрес с картинкой, например: http://адрес.ру/image/kartinka.png;http://адрес.ру/image/kartinka1.png</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.order','order' => 17)) . '</td><td class="priority">17</td><td>order</td><td>Порядок сортировки.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.active','order' => 18)) . '</td><td class="priority">18</td><td>active</td><td>Активный товар или нет, т.е. виден посетителям или нет. 1 - виден, 0 - не виден.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.show_in_menu','order' => 19)) . '</td><td class="priority">19</td><td>show_in_menu</td><td>Показывать товар в меню. Можно выводить товар в любом меню магазина, а не только в категории. 1 - показывать в меню, 0 - не показывать.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.yml_export','order' => 20)) . '</td><td class="priority">20</td><td>yml_export</td><td>Экспортировать товар в Яндекс Маркет или не экспортировать. 1 - экспортировать. 0 - не экспортировать.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.viewed','order' => 21)) . '</td><td class="priority">21</td><td>viewed</td><td>Количество просмотров товара.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.created','order' => 22)) . '</td><td class="priority">22</td><td>created</td><td>Дата создания товара.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.modified','order' => 23)) . '</td><td class="priority">23</td><td>modified</td><td>Дата модификации товара.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.action','order' => 24)) . '</td><td class="priority">24</td><td>action</td><td>Действие. <span class="text-danger">С помощью данной колонки можно массово удалять товары из интернет-магазина. Укажите в данной колонке <strong>delete</strong> напротив того товара, который Вы хотите удалить.</span></td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentProduct.tax_id','order' => 25)) . '</td><td class="priority">25</td><td>tax_id</td><td>Налог.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.template_id','order' => 26)) . '</td><td class="priority">26</td><td>template_id</td><td>Шаблон товара.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.is_group','order' => 27)) . '</td><td class="priority">27</td><td>is_group</td><td>Сгруппированный товар.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.id_group','order' => 28)) . '</td><td class="priority">28</td><td>id_group</td><td>Группа.</td></tr>
    </tbody>
</table>
...
<table class="table sortable_list">
    ...
    <tbody>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.alias','readonly' => true,'order' => 1)) . '</td><td class="priority">1</td><td>alias</td><td>Псевдоним элемента. <span class="text-danger">Проще говоря, псевдоним - это url адрес для контента, именно на основе псевдонима строится url адрес в магазине. Например, если укажите: test, то url адрес данного элемента в магазине будет: http://магазин.ру/тип-контента/test.html.</span></td></tr>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.name','readonly' => true,'order' => 2)) . '</td><td class="priority">2</td><td>name</td><td>Название.</td></tr>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.parents','readonly' => true,'order' => 3)) . '</td><td class="priority">3</td><td>parent</td><td>Категория, к которой относится элемент. <span class="text-danger">К какой категории относится элемент. Указывается название категории, подкатегории.</span></td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.description','order' => 4)) . '</td><td class="priority">4</td><td>description</td><td>Описание.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.short_description','order' => 5)) . '</td><td class="priority">5</td><td>short_description</td><td>Краткое описание.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.meta_title','order' => 6)) . '</td><td class="priority">6</td><td>meta_title</td><td>Заголовок Meta Title.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.meta_description','order' => 7)) . '</td><td class="priority">7</td><td>meta_description</td><td>Значение для тэга Meta Description.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ContentDescription.meta_keywords','order' => 8)) . '</td><td class="priority">8</td><td>meta_keywords</td><td>Значение для тэга Meta Keywords.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.image','order' => 9)) . '</td><td class="priority">9</td><td>image</td><td>Картинка. Название файла картинки, если картинок несколько, указывайте через точку с запятой, например: image.png;image1.png. Кроме того, можно указывать URL адрес с картинкой, например: http://адрес.ру/image/kartinka.png;http://адрес.ру/image/kartinka1.png</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.order','order' => 10)) . '</td><td class="priority">10</td><td>order</td><td>Порядок сортировки.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.active','order' => 11)) . '</td><td class="priority">11</td><td>active</td><td>Активный элемент или нет, т.е. виден посетителям или нет. 1 - виден, 0 - не виден.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.show_in_menu','order' => 12)) . '</td><td class="priority">12</td><td>show_in_menu</td><td>Показывать элемент в меню. Можно выводить элемент в любом меню магазина, а не только в категории. 1 - показывать в меню, 0 - не показывать.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.viewed','order' => 13)) . '</td><td class="priority">13</td><td>viewed</td><td>Количество просмотров элемента.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.created','order' => 14)) . '</td><td class="priority">14</td><td>created</td><td>Дата создания элемента.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.modified','order' => 15)) . '</td><td class="priority">15</td><td>modified</td><td>Дата модификации элемента.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.action','order' => 16)) . '</td><td class="priority">16</td><td>action</td><td>Действие. <span class="text-danger">С помощью данной колонки можно массово удалять элементы из интернет-магазина. Укажите в данной колонке <strong>delete</strong> напротив того элемента, который Вы хотите удалить.</span></td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Content.template_id','order' => 17)) . '</td><td class="priority">17</td><td>template_id</td><td>Шаблон элемента.</td></tr>
    </tbody>
</table>
...
<table class="table sortable_list">
    ...
    <tbody>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Customer.email','readonly' => true,'order' => 1)) . '</td><td class="priority">1</td><td>email</td><td>Email адрес покупателя. <span class="text-danger">Данное поле является ключом - проверяется, если клиента с таким email нет, то добавляется новый клиент, если есть - обновляются данные покупателя.</span></td></tr>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Customer.password','order' => 2)) . '</td><td class="priority">2</td><td>password</td><td>Пароль.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Customer.name','order' => 3)) . '</td><td class="priority">3</td><td>name</td><td>Имя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.ship_name','order' => 4)) . '</td><td class="priority">6</td><td>ship_name</td><td>Имя получателя заказа.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.ship_line_1','order' => 5)) . '</td><td class="priority">7</td><td>ship_line_1</td><td>Адрес.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.ship_line_2','order' => 6)) . '</td><td class="priority">8</td><td>ship_line_2</td><td>Дополнительная адресная информация.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.ship_city','order' => 7)) . '</td><td class="priority">9</td><td>ship_city</td><td>Город.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.ship_state','order' => 8)) . '</td><td class="priority">10</td><td>ship_state</td><td>Регион.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.ship_country','order' => 9)) . '</td><td class="priority">11</td><td>ship_country</td><td>Страна.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.ship_zip','order' => 10)) . '</td><td class="priority">12</td><td>ship_zip</td><td>Почтовый индекс.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.phone','order' => 11)) . '</td><td class="priority">13</td><td>phone</td><td>Телефон.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.created','order' => 12)) . '</td><td class="priority">14</td><td>created</td><td>Дата регистрации покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'AddressBook.modified','order' => 13)) . '</td><td class="priority">15</td><td>modified</td><td>Дата модификации покупателя.</td></tr>
    </tbody>
</table>
...
<table class="table sortable_list">
    ...
    <tbody>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.id','readonly' => true,'order' => 1)) . '</td><td class="priority">1</td><td>id</td><td>Номер заказа.</td></tr>
	<tr class="warning"><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.total','readonly' => true,'order' => 2)) . '</td><td class="priority">2</td><td>total</td><td>Сумма заказа.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.shipping','order' => 3)) . '</td><td class="priority">3</td><td>shipping</td><td>Стоимость доставки.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.tax','order' => 4)) . '</td><td class="priority">4</td><td>tax</td><td>Налог.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.order_status_id','order' => 5)) . '</td><td class="priority">5</td><td>order_status_id</td><td>Имя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.bill_name','order' => 6)) . '</td><td class="priority">6</td><td>bill_name</td><td>Имя покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.bil_line_1','order' => 7)) . '</td><td class="priority">7</td><td>bil_line_1</td><td>Адрес покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.bill_line_2','order' => 8)) . '</td><td class="priority">8</td><td>bill_line_2</td><td>Дополнительная адресная информация покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.bill_city','order' => 9)) . '</td><td class="priority">9</td><td>bill_city</td><td>Город покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.bill_state','order' => 10)) . '</td><td class="priority">10</td><td>bill_state</td><td>Регион покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.bill_country','order' => 11)) . '</td><td class="priority">11</td><td>bill_country</td><td>Страна покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.bill_zip','order' => 12)) . '</td><td class="priority">12</td><td>bill_zip</td><td>Почтовый индекс покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.email','order' => 13)) . '</td><td class="priority">13</td><td>email</td><td>Email адрес.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.phone','order' => 14)) . '</td><td class="priority">14</td><td>phone</td><td>Телефон.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.created','order' => 15)) . '</td><td class="priority">15</td><td>created</td><td>Дата заказа.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.customer_id','order' => 16)) . '</td><td class="priority">16</td><td>customer_id</td><td>Номер покупателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'PaymentMethod.name','order' => 17)) . '</td><td class="priority">17</td><td>payment_method_id</td><td>Способ оплаты.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'ShippingMethod.name','order' => 18)) . '</td><td class="priority">18</td><td>shipping_method_id</td><td>Способ доставки.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.ship_name','order' => 19)) . '</td><td class="priority">19</td><td>ship_name</td><td>Имя получателя заказа.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.ship_line_1','order' => 20)) . '</td><td class="priority">20</td><td>ship_line_1</td><td>Адрес получателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.ship_line_2','order' => 21)) . '</td><td class="priority">21</td><td>ship_line_2</td><td>Дополнительная адресная информация получателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.ship_city','order' => 22)) . '</td><td class="priority">22</td><td>ship_city</td><td>Город получателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.ship_state','order' => 23)) . '</td><td class="priority">23</td><td>ship_state</td><td>Регион получателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.ship_country','order' => 24)) . '</td><td class="priority">24</td><td>ship_country</td><td>Страна получателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.ship_zip','order' => 25)) . '</td><td class="priority">25</td><td>ship_zip</td><td>Почтовый индекс получателя.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.company_name','order' => 26)) . '</td><td class="priority">26</td><td>company_name</td><td>Название компании.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.company_info','order' => 27)) . '</td><td class="priority">27</td><td>company_info</td><td>Дополнительная информация о компании.</td></tr>
	<tr><td>' . $this->element('../ImportExport/checkbox_field',array('name_field' => 'Order.compant_vat','order' => 28)) . '</td><td class="priority">28</td><td>compant_vat</td><td>ИНН компании.</td></tr>
    </tbody>
</table>
