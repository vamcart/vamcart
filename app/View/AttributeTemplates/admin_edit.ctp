...
$this->Html->css(array(
	...
	echo $this->Form->create('AttributeTemplate', array('id' => 'contentform', 'url' => '/attribute_templates/admin_edit/save/'));		
	...
	echo $this->Admin->formButton(__('Apply'), 'cus-disk', array('class' => 'btn btn-primary', 'type' => 'submit', 'name' => 'submit')) . $this->Admin->formButton(__('Cancel'), 'cus-cancel', array('class' => 'btn btn-default', 'type' => 'submit', 'name' => 'cancelbutton'));
	echo $this->Form->end();
