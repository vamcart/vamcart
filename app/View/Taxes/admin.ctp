...
foreach ($tax_data AS $tax)
{
	...
	echo $this->Admin->TableCells(
		  array(
				...
				array($this->Admin->linkButton(__('Set All Products'), '/taxes/admin_set_all_products/' . $tax['Tax']['id'], 'cus-table-add', array('escape' => false, 'class' => 'btn btn-default'),$set_all_bug_fix), array('align'=>'center'))
		   ));
