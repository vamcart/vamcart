...
$count_attr = count($attributes);
    foreach ($attributes AS $attribute) {       
        echo $this->Admin->TableCells(array($attribute['Attribute']['name']
                                           ...
                                           ,array($this->Ajax->link(($attribute['Attribute']['is_show_var'] == 1?$this->Html->image('admin/icons/true.png', array('alt' => __('True'),'title' => __('True'))):$this->Html->image('admin/icons/false.png', array('alt' => __('False'),'title' => __('False')))), 'null', $options = array('escape' => false, 'url' => '/attributes/change_field_status/is_show_var/' . $attribute['Attribute']['id'], 'update' => 'view_attr'), null, false), array('align'=>'center'))                                               
