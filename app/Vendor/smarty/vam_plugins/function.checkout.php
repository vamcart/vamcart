...
<form action="{$checkout_form_action}" method="post" id="contentform" class="form-horizontal">
  ...
  <div id="bill_information">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="bill_name">{lang}Name{/lang}:</label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="bill_line_1">{lang}Address Line 1{/lang}:</label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="bill_line_2">{lang}Address Line 2{/lang}:</label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="bill_city">{lang}City{/lang}:</label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="bill_country">{lang}Country{/lang}:</label>
		<div class="col-sm-10">
	...
	<div id="bill_state_div">
		<label class="col-sm-2 control-label" for="bill_state">{lang}State{/lang}:</label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="bill_zip">{lang}Zipcode{/lang}:</label>
		<div class="col-sm-10">
  ...
  <div id="diff_ship">
    <div>
      <label for="diff_shipping"><input type="checkbox" class="form-control" name="diff_shipping" id="diff_shipping" value="1" /> {lang}My delivery and billing addresses are not the same.{/lang}</label>
    </div>
  </div>
  ...
  <div id="contact_information">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="email">{lang}E-mail{/lang}:</label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="phone">{lang}Phone{/lang}:</label>
		<div class="col-sm-10">
  ...
  <div id="shipping_method">
    ...
    {foreach from=$ship_methods item=ship_method}
      ...
      <span class="title">
        <input type="radio" class="form-control" name="shipping_method_id" value="{$ship_method.id}" id="ship_{$ship_method.id}" 
  ...
  <div id="payment_method">
    ...
    {foreach from=$payment_methods item=payment_method}
      ...
      <span class="title">
        <input type="radio" class="form-control" name="payment_method_id" value="{$payment_method.id}" id="payment_{$payment_method.id}" 
