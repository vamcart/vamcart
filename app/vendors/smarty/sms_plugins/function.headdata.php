...
function smarty_help_function_headdata() {
	...
	<p>Displays the head data for this content.  Edit the head data for each content item under the options tab.</p>
	<h3>How do I use it?</h3>
	<p>Just insert the tag into your template like: <code>{headdata}</code></p>
