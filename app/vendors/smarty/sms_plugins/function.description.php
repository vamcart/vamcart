...
function smarty_help_function_description() {
	...
	<p>Outputs the description of the current page, product, or category depending on the user's default selected language.</p>
	<h3>How do I use it?</h3>
	<p>Just insert the tag into your template like: <code>{description}</code></p>
