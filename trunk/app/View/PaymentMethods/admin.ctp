...
foreach ($modules AS $module)
{
	...
	{
		$action_button = $this->Admin->linkButton(__('Install'),'/payment/' . $module['alias'] . '/install/','cus-add',array('escape' => false, 'class' => 'btn'));
	}
	else
	{
		$action_button = $this->Admin->linkButton(__('Uninstall'),'/payment/' . $module['alias'] . '/uninstall/','cus-cancel',array('escape' => false, 'class' => 'btn'),__('Are you sure?'));
	}
...
echo $this->Admin->linkButton(__('Add module'), '/payment_methods/admin_add/', 'cus-plugin-add', array('escape' => false, 'class' => 'btn'));
