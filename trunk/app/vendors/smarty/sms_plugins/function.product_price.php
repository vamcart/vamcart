...
function smarty_function_product_price($params, &$smarty)
{
	global $content;
...
function smarty_help_function_product_price () {
	...
	<p>Displays the product price for the current content.</p>
	<h3>How do I use it?</h3>
	<p>Just insert the tag into your template like: <code>{product_price}</code></p>
