...
foreach ($templates AS $template)
{
	...
	{
		$arrow_link = $ajax->link($html->image('admin/expand.gif'), 'null', $options = array('url' => '/templates/expand_section/' . $template['Template']['id'], 'update' => 'inner-content'), null, false);
		$collapse_style = "display:none;";
	}
	else
	{
		$collapse_style = " ";
		$arrow_link = $ajax->link($html->image('admin/contract.gif'), 'null', $options = array('url' => '/templates/contract_section/' . $template['Template']['id'], 'update' => 'inner-content'), null, false);
	}
