...
foreach ($content_data AS $content)
{
	...
	echo $admin->TableCells(
		  array(
				...
				$ajax->link(($content['Content']['active'] == 1?$html->image('admin/icons/true.png'):$html->image('admin/icons/false.png')), 'null', $options = array('url' => '/contents/admin_change_active_status/' . $content['Content']['id'], 'update' => 'content'), null, false),
				$ajax->link(($content['Content']['show_in_menu'] == 1?$html->image('admin/icons/true.png'):$html->image('admin/icons/false.png')), 'null', $options = array('url' => '/contents/admin_change_show_in_menu_status/' . $content['Content']['id'], 'update' => 'content'), null, false),
