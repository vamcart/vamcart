...
echo $html->tableHeaders(array( __('Title', true), __('Default', true), __('Active', true), __('Media Type', true), __('Action', true), '<input type="checkbox" onclick="checkAll(this)" />'));
...
foreach ($stylesheets AS $stylesheet)
{
	echo $admin->TableCells(
		  array(
			...
			array($admin->DefaultButton($stylesheet['Stylesheet']), array('align'=>'center')),
