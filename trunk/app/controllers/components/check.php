...
class CheckComponent extends Object
{
	...
	function startup(&$controller)
	{
		if(strpos($_SERVER['REQUEST_URI'],'admin') !== FALSE &&
			  ...
			  strpos($_SERVER['REQUEST_URI'],'admin_login') === FALSE &&
			  strpos($_SERVER['REQUEST_URI'],'license') === FALSE) {
...
<?php
		...
		if (strpos($_SERVER['REQUEST_URI'],'admin') !== FALSE &&
			   ...
			   $this->get($this->data['License']['licenseKey']) == 'true') {
...
?>
				...
				<div id="jquery-msg-overlay" class="black-on-white" style="position: absolute; z-index: 1000; top: 0px; right: 0px; left: 0px; height: 100%; display: block; "><img src="<?php echo BASE ?>/img/admin/transparency.png" id="jquery-msg-bg" style="width: 100%; height: 100%; top: 0px; left: 0px;"><div id="jquery-msg-content" class="jquery-msg-content" style="position: absolute; display: block; left: 50%; top: 50%; margin: -50px 0 0 -230px; "><p><?php __('New version available. VamCart') ?> <?php echo $latest_version; ?>!<br /><?php __('Go to Admin - Configurations -') ?> <a href="<?php echo BASE ?>/update/admin/" style="color:#FF0000"><?php __('Update') ?></a> <?php __('and update your store.') ?></p><p style="font-size: 11px;"><a href="javascript:void(0)" onClick="closeNotice();"><?php __('Close') ?></a></p></div></div>
<?php
			}
		}
	...
	function get_latest_update_version()
	{
		$host = $this->check_host();
	...
	function get_list_update_version($current_version)
	{
		$host = $this->check_host();
	...
	function get_update_archive($version)
	{
		$host = $this->check_host();
