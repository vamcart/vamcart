...
(359, 51, 1, 'Confirmation', '{google_analytics checkout_success=true}\r\n{yandex_metrika checkout_success=true}\r\n\r\n{payment}\r\n{shipping}\r\n\r\n<h2>{lang}Cart Contents{/lang}</h2>\r\n{shopping_cart template=''payment-view-cart''}','', '', ''),
(360, 51, 2, 'Подтверждение заказа', '{google_analytics checkout_success=true}\r\n{yandex_metrika checkout_success=true}\r\n\r\n{payment}\r\n{shipping}\r\n\r\n<h2>{lang}Cart Contents{/lang}</h2>\r\n{shopping_cart template=''payment-view-cart''}','', '', ''),
