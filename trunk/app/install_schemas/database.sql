...
(14, 'news-box', '<!-- News box -->\r\n<div class="box">\r\n<h5>{lang}News{/lang}</h5>\r\n<div class="boxContent">\r\n<ul>\r\n{foreach from=$content_list item=node}\r\n<li{if $node.alias == $content_alias} class="active"{/if}><a href="{$node.url}">{$node.name}</a></li>\r\n{/foreach}\r\n</ul>\r\n</div>\r\n</div>\r\n<!-- /News box -->', '2009-07-12 18:52:23', '2009-11-01 19:20:58', 'content_listing'),
(15, 'articles-box', '<!-- Articles box -->\r\n<div class="box">\r\n<h5>{lang}Articles{/lang}</h5>\r\n<div class="boxContent">\r\n<ul>\r\n{foreach from=$content_list item=node}\r\n<li{if $node.alias == $content_alias} class="active"{/if}><a href="{$node.url}">{$node.name}</a></li>\r\n{/foreach}\r\n</ul>\r\n</div>\r\n</div>\r\n<!-- /Articles box -->', '2009-07-12 18:52:23', '2009-11-01 19:20:58', 'content_listing');
