...
(8, 1, 7, 0, 'Downloadable Product Info', '<link rel="stylesheet" type="text/css" href="{base_path}/css/jquery.fancybox-1.2.5.css" media="screen" />\r\n<script type="text/javascript" src="{base_path}/js/jquery/plugins/fancybox/jquery.fancybox-1.2.5.pack.js"></script>\r\n\r\n<script type="text/javascript">\r\n  $(document).ready(function() {\r\n    $("a.zoom").fancybox({\r\n    "zoomOpacity"      : true,\r\n    "overlayShow"      : false,\r\n    "zoomSpeedIn"      : 250,\r\n    "zoomSpeedOut"      : 250\r\n  });\r\n  });\r\n\r\n  function onProductFormSubmit() {\r\n    var str = $("#product-form").serialize();\r\n\r\n    $.post("/cart/purchase_product", str, function(data) {\r\n      $("#shopping-cart-box").html(data);\r\n    });\r\n\r\n  }\r\n</script>\r\n\r\n\r\n<div id="product_details_left">\r\n  {description}\r\n</div>\r\n<div id="product_details_right">\r\n  <div class="product_images">{content_images}</div>\r\n  <div class="pricing">\r\n{downloadable_prices}\r\n    <div style="clear: both"></div>\r\n    <div style="clear: both"></div>\r\n    {if ''1'' == $ajax_enable}\r\n        {product_form_ajax}\r\n        <div class="product_price">{product_quantity} {purchase_button id=$content_id}</div>\r\n        {/product_form_ajax}\r\n    {else}\r\n        {product_form}\r\n        <div class="product_price">{product_quantity} {purchase_button id=$content_id}</div>\r\n        {/product_form}\r\n    {/if}\r\n    {module alias=''reviews'' action=''link''}\r\n  </div>\r\n</div>\r\n<div style="clear:both;"></div>', '2012-11-04 00:00:00', '2013-04-17 16:07:25');
...
(3, 'Product Info', '<link rel="stylesheet" type="text/css" href="{base_path}/css/jquery.fancybox-1.2.5.css" media="screen" />\r\n<script type="text/javascript" src="{base_path}/js/jquery/plugins/fancybox/jquery.fancybox-1.2.5.pack.js"></script>\r\n\r\n<script type="text/javascript">\r\n  $(document).ready(function() {\r\n    $("a.zoom").fancybox({\r\n    "zoomOpacity"      : true,\r\n    "overlayShow"      : false,\r\n    "zoomSpeedIn"      : 250,\r\n    "zoomSpeedOut"      : 250\r\n  });\r\n  });\r\n\r\n  function onProductFormSubmit() {\r\n    var str = $("#product-form").serialize();\r\n\r\n    $.post("/cart/purchase_product", str, function(data) {\r\n      $("#shopping-cart-box").html(data);\r\n    });\r\n\r\n  }\r\n</script>\r\n\r\n\r\n<div id="product_details_left">\r\n  {description}\r\n</div>\r\n<div id="product_details_right">\r\n  <div class="product_images">{content_images}</div>\r\n  <div class="pricing">\r\n{product_prices}\r\n    <div style="clear: both"></div>\r\n    <div style="clear: both"></div>\r\n    {if ''1'' == $ajax_enable}\r\n	    {product_form_ajax}\r\n	    <div class="product_price">{product_quantity} {purchase_button id=$content_id}</div>\r\n	    {/product_form_ajax}\r\n    {else}\r\n	    {product_form}\r\n	    <div class="product_price">{product_quantity} {purchase_button id=$content_id}</div>\r\n	    {/product_form}\r\n    {/if}\r\n    {module alias=''reviews'' action=''link''}\r\n  </div>\r\n</div>\r\n<div style="clear:both;"></div>'),
(4, 'Category Info', '{description}\r\n\r\n{if $sub_count->value.categories > 0}\r\n    <h3>{lang}Sub Categories{/lang}</h3>\r\n    <div class="content_listing">\r\n        {content_listing template=''subcategory-listing'' parent={$content_id} type=''category''}\r\n    </div>\r\n{/if}\r\n\r\n{if $sub_count->value.products + $sub_count->value.downloadables > 0}\r\n    <h3>{lang}Products in this Category{/lang}</h3>\r\n    <div class="content_listing">\r\n        {content_listing template=''product-listing'' parent={$content_id} page={$page} type=''product,downloadable''}\r\n    </div>\r\n{/if}'),
(5, 'News Page', '{description}'),
(6, 'Article Page', '{description}'),
(7, 'Downloadable Product Info', '<link rel="stylesheet" type="text/css" href="{base_path}/css/jquery.fancybox-1.2.5.css" media="screen" />\r\n<script type="text/javascript" src="{base_path}/js/jquery/plugins/fancybox/jquery.fancybox-1.2.5.pack.js"></script>\r\n\r\n<script type="text/javascript">\r\n  $(document).ready(function() {\r\n    $("a.zoom").fancybox({\r\n    "zoomOpacity"      : true,\r\n    "overlayShow"      : false,\r\n    "zoomSpeedIn"      : 250,\r\n    "zoomSpeedOut"      : 250\r\n  });\r\n  });\r\n\r\n  function onProductFormSubmit() {\r\n    var str = $("#product-form").serialize();\r\n\r\n    $.post("/cart/purchase_product", str, function(data) {\r\n      $("#shopping-cart-box").html(data);\r\n    });\r\n\r\n  }\r\n</script>\r\n\r\n\r\n<div id="product_details_left">\r\n  {description}\r\n</div>\r\n<div id="product_details_right">\r\n  <div class="product_images">{content_images}</div>\r\n  <div class="pricing">\r\n{downloadable_prices}\r\n    <div style="clear: both"></div>\r\n    <div style="clear: both"></div>\r\n    {if ''1'' == $ajax_enable}\r\n        {product_form_ajax}\r\n        <div class="product_price">{product_quantity} {purchase_button id=$content_id}</div>\r\n        {/product_form_ajax}\r\n    {else}\r\n        {product_form}\r\n        <div class="product_price">{product_quantity} {purchase_button id=$content_id}</div>\r\n        {/product_form}\r\n    {/if}\r\n    {module alias=''reviews'' action=''link''}\r\n  </div>\r\n</div>\r\n<div style="clear:both;"></div>');
